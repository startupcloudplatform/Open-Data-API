...
router.get('/:openapi_no', function(req, res, next) {
    ...
    pool.getConnection(function(err, conn){
        conn.query(sql, function(err, rows) {
            ...
            var sql2 = 'select * from odag.service_matching where odag.service_matching.key= \'' + odagkey + '\' and odag.service_matching.service_id = \'' + openapi_no + '\'';
                ...
                conn.query(sql2, function (err, rows2) {
                    ...
                    if(rows2.length === 1){
                        ...
                        request(url, function (error, response, body) {
                            ...
                            var sql3 = 'select * from odag.developer where odag.developer.auth_key = \'' + odagkey + '\'';
