...
router.get('/:category', function(req, res, next) {
    var sql = mysql.format(
        'SELECT a.openapi_no, a.name, a.provider, a.comment, a.update_time, a.views_count, b.category, a.activity_type, a.type FROM odag.openapi a, odag.category_odag b where a.category = b.category_no and b.category = ? and a.progress = \'등록 완료\'' +
        'union all \n' +
        'select a.filedata_id, a.name, a.provider, a.comment, a.update_time, a.views_count, b.category, a.activity_type, a.type from odag.filedata a, odag.category_odag b where a.category = b.category_no and b.category = ?  and a.progress = \'등록 완료\'' +
