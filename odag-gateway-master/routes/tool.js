...
router.get('/', function(req, res, next) {
    var sql = mysql.format(
        'SELECT a.tool_no, a.name, a.provider, a.comment, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.views_count, b.category, a.activity_type, a.type, a.keyword FROM odag.tool a, odag.category_tool b where a.category = b.category_no',
    );
...
router.get('/bigdata', function(req, res, next) {
    var sql = mysql.format(
        'SELECT a.tool_no, a.name, a.provider, a.comment, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.views_count, b.category, a.activity_type, a.type, a.keyword FROM odag.tool a, odag.category_tool b where a.category = 1 and a.category = b.category_no',
    );
...
router.get('/AI', function(req, res, next) {
    var sql = mysql.format(
        'SELECT a.tool_no, a.name, a.provider, a.comment, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.views_count, b.category, a.activity_type, a.type, a.keyword FROM odag.tool a, odag.category_tool b where a.category = 2 and a.category = b.category_no',
    );
...
router.get('/bigdata/:tool_no', function(req, res, next) {
    var sql = mysql.format(
        'SELECT a.tool_no, a.name, a.provider, a.comment, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.views_count, b.category, a.activity_type, a.type, c.provider_person, c.provider_phone, c.provider_deliberate, c.provider_traffic, a.keyword, a.code, a.tool_use_url url FROM odag.tool a, odag.category_tool b, odag.provider c where a.tool_no = ? and a.category = 1 and a.category = b.category_no and a.provider = c.provider_name',
        [req.params.tool_no]
    );
            ...
            if (rows.length === 0) {
                ...
                for (var a=0;a<rows.length;a++) {
                    ...
                    var sql2 = mysql.format(
                        'update odag.tool set odag.tool.views_count = odag.tool.views_count + 1 where tool_no = \'' + tool_no2 + '\''
                    );
...
router.get('/AI/:tool_no', function(req, res, next) {
    var sql = mysql.format(
        'SELECT a.tool_no, a.name, a.provider, a.comment, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.views_count, b.category, c.provider_person, c.provider_phone, c.provider_deliberate, c.provider_traffic, a.activity_type, a.type, a.tool_use_url url, a.keyword, a.code FROM odag.tool a, odag.category_tool b, provider c where a.tool_no = ? and a.category = 2 and a.category = b.category_no and a.provider = c.provider_name',
        [req.params.tool_no]
    );
