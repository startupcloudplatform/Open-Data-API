...
router.get('/developer', function(req, res, next) {
    ...
    var sql = mysql.format(
        'select  a.user_id, a.user_mail, a.user_name, date_format(a.create_time, \'%Y-%m-%d\')create_time, a.user_call, a.auth_key, a.category from odag.developer a ' + i,
        value
    );
    console.log(sql);
...
router.get('/provider', function(req, res, next) {
    ...
    var sql = mysql.format(
        'select *, date_format(create_time, \'%Y-%m-%d\')creates_time from odag.provider a ' + i,
        value
    );
    console.log(sql);
...
router.get('/apilist', function(req, res, next) {
    ...
    if(req.query.user_search != null && req.query.category === 'keyword') {
        ...
        var sql = mysql.format(
        'SELECT c.provider_person, c.provider_mail, a.openapi_join_url, a.openapi_no, a.name, a.provider, a.comment, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.views_count, b.category, c.provider_person, c.provider_phone, c.provider_mail, a.activity_type, a.type, a.keyword FROM odag.openapi a, odag.category_odag b, odag.provider c ' + i,
        value
    );
    console.log(sql);
...
router.get('/opendata_delete', function(req, res, next) {
    ...
    var sql = mysql.format(
        'SELECT c.provider_person, c.provider_phone ,c.provider_mail, a.openapi_join_url, a.openapi_no, a.name, a.provider, a.comment, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.views_count, b.category, a.activity_type, a.type, a.keyword FROM odag.openapi a, odag.category_odag b, odag.provider c ' + i,
        value
    );
    console.log(sql);
...
router.get('/filedata', function(req, res, next) {
    ...
    var sql = mysql.format(
        'SELECT a.name, a.progress, a.filedata_id, a.activity_type, a.keyword, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.comment,a.views_count, a.type, a.provider, b.provider_person, b.provider_phone, b.provider_mail FROM odag.filedata a, odag.provider b ' + i,
        value
    );
    console.log(sql);
...
router.get('/filedata_cancle', function(req, res, next) {
    ...
    var sql = mysql.format(
        'SELECT a.name, a.progress, a.filedata_id, a.activity_type, a.keyword, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.comment,a.views_count, a.type, a.provider, b.provider_person, b.provider_phone, b.provider_mail, b.provider_person, b.provider_mail, b.provider_phone FROM odag.filedata a, odag.provider b ' + i,
        value
    );
    console.log(sql);
