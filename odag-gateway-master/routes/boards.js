            ...
            if (rows.length === 0) {
                ...
                for (var a=0;a<rows.length;a++) {
                    ...
                    var sql2 = mysql.format(
                        'update odag.community set odag.community.count = odag.community.count + 1 where community_no = \'' + community_no2 + '\''
                    );
...
router.post('/', function(req, res, next) {
    ...
    var sql = mysql.format(
        'INSERT INTO odag.community (community_title, community_contents, user_id) ' +
        'values (?,?,?)',
...
router.put('/:community_no', function(req, res, next) {
    ...
    var sql = mysql.format(
        'UPDATE odag.community SET community_title = ?, community_contents = ?, user_id = ?, update_time = CURRENT_TIMESTAMP where community_no = ?',
...
router.put('/targetup/:community_no', function(req, res, next) {
    ...
    var sql = mysql.format(
        'UPDATE odag.community SET target = 1 where community_no = ? ',
        [req.params.community_no]
    );
...
router.put('/targetdown/:community_no', function(req, res, next) {
    ...
    var sql = mysql.format(
        'UPDATE odag.community SET target = 0 where community_no = ? ',
        [req.params.community_no]
    );
...
router.post('/board_no/:community_no/comment', function(req, res, next) {
    ...
    var sql = mysql.format(
        'INSERT INTO odag.community_reply (community_no, community_reply_contents, user_id) ' +
        'values (?,?,?)',
...
router.put('/:community_no/comment/:community_reply_no', function(req, res, next) {
    ...
    var sql = mysql.format(
        'UPDATE odag.community_reply SET community_reply_contents = ?, update_time = CURRENT_TIMESTAMP where community_no = ? and community_reply_no = ?',
