...
router.get('/', function(req, res, next) {
    var sql = mysql.format(
        'select a.filedata_id as openapi_no, a.name, a.provider, a.comment, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.views_count, b.category, a.activity_type, a.type from odag.filedata a, odag.category_odag b where a.category = b.category_no and a.progress = \'등록 완료\'',
    );
            ...
            if (rows.length === 0) {
                ...
                for (var a=0;a<rows.length;a++) {
                    ...
                    var sql3 = mysql.format(
                        'update odag.filedata set odag.filedata.views_count = odag.filedata.views_count + 1 where filedata_id = \'' + filedata_id2 + '\''
                    );
                ...
                pool.getConnection(function(err, conn2){
                    conn2.query(sql2, function(err, rows2) {
                        ...
                        if (rows2.length === 0) {
                            ...
                            var sql3 = mysql.format(
                              'insert into odag.history_filedata(filedata_no, user_id, history_id, status, comment)'+
                              'values (?,?,?,?,?)',
                                ...
                                conn.query(sql3, function (err,rows3) {
                                    ...
                                    if(rows3.length == 1){
                                        ...
                                        var sql4 = mysql.format(
                                            'update odag.history_filedata AS a, odag.filedata AS b, odag.provider AS c set a.provider = b.provider, a.provider_id = c.user_id where a.filedata_no = b.filedata_id and b.provider = c.provider_name'
                                        );
                                        pool.getConnection(function (err,conn) {
...
router.post('/download/:filedata_id', function(req, res, next) {
    var sql = mysql.format(
        'insert into odag.history_filedata (filedata_no, user_id, history_id, status, comment, update_time) ' +
...
router.get('/:filedata_id/provider_update', function(req, res, next) {
    var sql = mysql.format(
        'SELECT distinct(a.filedata_id),d.name, e.cnt, d.category catecate, a.provider, d.type, date_format(a.update_time, \'%Y-%m-%d\')update_time, b.category, d.activity_type, c.provider_person, d.keyword, c.provider_phone, d.filedata_use_url, d.comment, d.views_count from odag.filedata_temp a, odag.category_odag b, odag.provider c, odag.filedata d, (select count(*) cnt from odag.history_filedata where history_filedata.filedata_no = ? and history_filedata.history_id = \'7\') e where a.filedata_id = ? and a.category = b.category_no and a.provider = c.provider_name and a.filedata_id = d.filedata_id',
        [req.params.filedata_id,req.params.filedata_id]
    );
...
router.get('/:filedata_no/provider/filedata_detail', function(req, res, next) {
    var sql = mysql.format(
        'SELECT d.name, a.filedata_no, a.filedata_id, a.name filedata_detail_name, a.filedata_key filedata_detail_key from odag.filedata_detail a, odag.filedata d where a.filedata_no = ? and a.filedata_id = d.filedata_id and (a.progress = \'등록 완료\' or a.progress = \'수정 준비 중\')',
...
router.get('/:filedata_id/provider/update', function(req, res, next) {
    var sql = mysql.format(
        'SELECT distinct(a.filedata_id),d.name, a.name filedata_detail_name, a.filedata_no, a.filedata_key filedata_detail_key, d.category catecate, a.provider, d.type, date_format(a.update_time, \'%Y-%m-%d\')update_time, b.category, d.activity_type, c.provider_person, d.keyword, c.provider_phone, d.filedata_use_url, d.comment, d.views_count from odag.filedata_detail a, odag.category_odag b, odag.provider c, odag.filedata_temp d where a.filedata_id = ? and a.category = b.category_no and a.provider = c.provider_name and a.filedata_id = d.filedata_id',
        [req.params.filedata_id]
    );
...
router.get('/provider/filedata_update', function(req, res, next) {
    var sql = mysql.format(
        'SELECT distinct(a.filedata_id),d.name,d.category catecate, a.provider, d.type, date_format(a.update_time, \'%Y-%m-%d\')update_time, b.category, d.activity_type, c.provider_person, d.keyword, c.provider_phone, d.filedata_use_url, d.comment, d.views_count, c.provider_mail from odag.filedata a, odag.category_odag b, odag.provider c, odag.filedata_temp d where a.category = b.category_no and a.provider = c.provider_name and a.filedata_id = d.filedata_id',
    );
...
router.get('/provider/filedata_update_detail', function(req, res, next) {
    var sql = mysql.format(
        'SELECT distinct(a.filedata_id),d.name, a.name filedata_detail_name, a.filedata_no, a.filedata_key filedata_detail_key, d.category catecate, a.provider, d.type, date_format(a.update_time, \'%Y-%m-%d\')update_time, b.category, d.activity_type, c.provider_person, d.keyword, c.provider_phone, d.filedata_use_url, d.comment, d.views_count from odag.filedata_detail a, odag.category_odag b, odag.provider c, odag.filedata_temp d where a.category = b.category_no and a.provider = c.provider_name and a.filedata_id = d.filedata_id',
    );
...
router.put('/:filedata_id/provider', function(req, res, next) {
    var sql = mysql.format(
        'insert ignore into odag.filedata_temp(filedata_temp.name,category,comment,filedata_use_url,keyword,filedata_temp.type,update_time,progress,filedata_id) ' +
    ...
    pool.getConnection(function(err, conn){
        conn.query(sql, function(err, rows) {
            ...
            if (rows.length === 0) {
                ...
                var sql2 = mysql.format(
                    'UPDATE odag.filedata SET update_time = CURRENT_TIMESTAMP, progress = \'수정 대기 중\' where filedata_id = ?',
                ...
                var sql3 = mysql.format(
                    'update odag.filedata_temp, filedata set filedata_temp.provider = filedata.provider where filedata_temp.filedata_id = filedata.filedata_id '
                )
                pool.getConnection(function (err,conn) {
                ...
                var sql4 = mysql.format(
                    'insert into odag.filedata_temp_detail(filedata_temp_detail.name,filedata_temp_detail.filedata_key, filedata_temp_detail.progress, filedata_temp_detail.filedata_no) ' +
                    'values (?,?,\'수정 대기 중\',?)',
                    ...
                    conn.query(sql4, function(err, rows4) {
                        ...
                        if (rows4.length === 0) {
                            ...
                            var sql5 = mysql.format(
                                'UPDATE odag.filedata_detail SET update_time = CURRENT_TIMESTAMP, progress = \'수정 대기 중\' where filedata_no = ?',
...
router.put('/:filedata_id/provider/update', function(req, res, next) {
    var sql = mysql.format(
        'UPDATE odag.filedata_temp SET filedata_temp.name = ?,category = ? ,comment = ? ,filedata_use_url = ? ,keyword = ?, filedata_temp.type = ?, update_time = CURRENT_TIMESTAMP, progress = \'수정 대기 중\' where filedata_id = ?',
        [req.body.name, req.body.category, req.body.comment, req.body.filedata_use_url, req.body.keyword, '' + req.body.type + '', req.body.filedata_id]
    );
    console.log(sql);
...
router.put('/:filedata_id/provider/updates', function(req, res, next) {
    var sql = mysql.format(
        'insert ignore into odag.filedata_temp(filedata_temp.name,provider,category,comment,filedata_use_url,keyword,filedata_temp.type,update_time,progress,filedata_id) ' +
        'values (?,?,?,?,?,?,?,CURRENT_TIMESTAMP,\'수정 대기 중\',?)',
...
router.put('/:filedata_id/provider/delete', function(req, res, next) {
    var sql = mysql.format(
        'UPDATE odag.filedata SET update_time = CURRENT_TIMESTAMP, progress = \'삭제 대기 중\' where filedata_id = ?',
        [req.body.filedata_id]
    );
    console.log(sql);
...
router.put('/:filedata_no/provider_detail/delete', function(req, res, next) {
    var sql = mysql.format(
        'UPDATE odag.filedata_detail SET update_time = CURRENT_TIMESTAMP, progress = \'삭제 대기 중\' where filedata_no = ?',
        [req.body.filedata_no]
    );
    console.log(sql);
...
router.put('/:filedata_id/provider/enroll', function(req, res, next) {
    var sql = mysql.format(
        'UPDATE odag.filedata SET filedata.name = ?,category = ? ,comment = ? ,filedata_use_url = ? ,keyword = ?, filedata.type = ?, update_time = CURRENT_TIMESTAMP, progress = \'등록 준비 중\' where filedata_id = ?',
        [req.body.name, req.body.category, req.body.comment, req.body.filedata_use_url, req.body.keyword, '' + req.body.type + '', req.body.filedata_id]
    );
...
router.get('/provider_all/filedata', function(req, res, next) {
    ...
    var sql = mysql.format(
        'SELECT a.name, a.progress, a.filedata_id, a.activity_type, a.keyword, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.comment,a.views_count, a.type, a.provider, b.provider_person, b.provider_phone, b.provider_mail FROM odag.filedata a, odag.provider b WHERE a.provider = b.provider_name and a.progress = \'등록 준비 중\' ',
    );
...
router.get('/provider_delete/filedata', function(req, res, next) {
    // console.log(req.params.user_id);
    var sql = mysql.format(
        'SELECT a.name, a.progress, a.filedata_id, a.activity_type, a.keyword, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.comment,a.views_count, a.type, a.provider, b.provider_person, b.provider_phone, b.provider_mail FROM odag.filedata a, odag.provider b WHERE a.provider = b.provider_name and a.progress = \'삭제 대기 중\' ',
    );
...
router.put('/filedata_request/accept', function(req, res, next) {
    var sql = mysql.format(
        'UPDATE odag.filedata SET update_time = CURRENT_TIMESTAMP, progress = \'등록 완료\' where filedata_id = ?',
        [req.body.filedata_id]
    );
    ...
    pool.getConnection(function(err, conn){
        conn.query(sql, function(err, rows) {
            ...
            if (rows.length === 0) {
                ...
                var sql2 = mysql.format(
                    'UPDATE odag.filedata_detail SET update_time = CURRENT_TIMESTAMP, progress = \'등록 완료\' where filedata_id = ?',
                    [req.body.filedata_id]
                );
                pool.getConnection(function (err, conn) {
                    conn.query(sql2, function (err, rows2) {
    ...
    pool.getConnection(function(err, conn){
        conn.query(sql, function(err, rows) {
            ...
            if (rows.length === 0) {
                ...
                var sql3 = mysql.format(
                    'delete from odag.filedata_temp where filedata_id = ?',
                    [req.body.filedata_id]
                );
                pool.getConnection(function (err, conn) {
                    conn.query(sql3, function (err, rows3) {
...
router.put('/filedata_delete/accept', function(req, res, next) {
    var sql = mysql.format(
        'delete from odag.filedata where filedata_id = ?',
        [req.body.filedata_id]
    );
    ...
    pool.getConnection(function(err, conn){
        conn.query(sql, function(err, rows) {
            ...
            if (rows.length === 0) {
                ...
                var sql2 = mysql.format(
                    'delete from odag.filedata_detail where filedata_id = ?',
                    [req.body.filedata_id]
                );
                pool.getConnection(function (err, conn) {
                    conn.query(sql2, function (err, rows2) {
...
router.put('/filedata_request/reject', function(req, res, next) {
    var sql = mysql.format(
        'UPDATE odag.filedata SET update_time = CURRENT_TIMESTAMP, progress = \'등록 거절\' where filedata_id = ?',
        [req.body.filedata_id]
    );
    ...
    pool.getConnection(function(err, conn){
        conn.query(sql, function(err, rows) {
            ...
            if (rows.length === 0) {
                ...
                var sql2 = mysql.format(
                    'insert into odag.history_admin_filedata (filedata_no, history_id, status, comment, update_time, provider, provider_id) ' +
...
router.put('/filedata_update/reject', function(req, res, next) {
    var sql = mysql.format(
        'UPDATE odag.filedata SET update_time = CURRENT_TIMESTAMP, progress = \'수정 거절\' where filedata_id = ?',
        [req.body.filedata_id]
    );
...
router.put('/filedata_delete/reject', function(req, res, next) {
    var sql = mysql.format(
        'UPDATE odag.filedata SET update_time = CURRENT_TIMESTAMP, progress = \'삭제 거절\' where filedata_id = ?',
        [req.body.filedata_id]
    );
...
router.get('/provider_cancle/filedata', function(req, res, next) {
    // console.log(req.params.user_id);
    var sql = mysql.format(
        'SELECT a.name, a.progress, a.filedata_id, a.activity_type, a.keyword, date_format(a.update_time, \'%Y-%m-%d\')update_time, a.comment,a.views_count, a.type, a.provider, b.provider_person, b.provider_mail, b.provider_phone FROM odag.filedata a, odag.provider b WHERE a.provider = b.provider_name and a.progress = \'서비스 중지\' ',
    );
