...
<body>
  ...
  <div class="contentInner">
    <div class="snb">
      <h3>오픈데이터 추천</h3>
      <ul>
        <li><a href="<c:url value="/recommendPopular" />">실시간 인기 오픈데이터</a></li>
        <li class="current"><a href="<c:url value="/recommendMycategory" />">내 산업군 인기 오픈데이터</a></li>
        <!-- 
  ...
  var apiList = Array();
  var printApiList = function(searchText){
  ...
  var setClickEventUse = function(useButtonId, api, userNo) {
	...
	$(document).ready(function() {
		...
		printApiList("${sessionScope.SESSION_USER.companyCategory}");
	});
