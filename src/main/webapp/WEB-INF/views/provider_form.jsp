  ...
  <main class="main_snb">
    <div class="contentInner">
      ...
      <ul class="api_form">
        ...
        <form method="post" action="/openapiCreate">
          <section class="wrap_tb_signup">
            <table class="tb_signup">
              <tr>
                <th>오픈데이터 이름</th>
                <td>
                  <input name="openapiName" type="text" id="">
                </td>
              </tr>
              ...
              <tr>
                <th>오픈데이터 제공처</th>
                <td>
                  <input name="openapiProvider" type="text" id="" readonly value="${sessionScope.SESSION_USER.companyName}">
                </td>
              </tr>
              ...
              <tr>
                <th>오픈데이터 설명</th>
                <td>
                  <div class="wrap_textarea"><textarea name="openapiComment"  id=""></textarea></div>
                </td>
              </tr>
              ...
              <tr>
                <th>서비스 이용 URL</th>
                <td>
                  <input name="openapiUseUrl" type="text" id="">
                </td>
              </tr>
              ...
              <tr>
                <th>서비스 신청 URL</th>
                <td>
                  <input name="openapiJoinUrl" type="text" id="">
                </td>
              </tr> 
              ...
              <tr>
                <th>키워드</th>
                <td>
                  <input name="openapiKeyword" type="text" id="">
                </td>
              </tr>
          ...
          <div class="btm_btn">
            <button type="submit" class="btn_confirm" id="btn_opendata_add">등록</button><br><br>
          </div>
			...
			success : function(serverData) {
				...
				$(apiList).each(function(apiIndx){
					...
					if(printState)
					{
						...
						html +='    <input type="checkbox" name="checkbox_api" id=""><label for="">'+api.openapiName+'</label> <a href="'+api.openapiUseUrl+'">'+api.openapiUrl.split('?')[0]+'</a>';
						if(api.openapiUseType == 1){
							...
							if(api.use == true){
								...
								html +='      <button type="button" class="btn_detail_copy"  id=token'+api.openapiNo+' >수정</button>';
								html +='    </div>';
							}
						}
						html +='  </div>';  
