    ...
    <main class="main_snb">
        <div class="contentInner">
            ...
            <div class="snb">
                <h3>마이 오픈데이터</h3>
                <ul>
                    <li class="current"><a href="<c:url value="/myapi" />">마이 오픈API</a></li>
			...
			success : function(serverData) {
				...
				$(apiList).each(function(apiIndx){
					...
					if(printState)
					{
						...
						html +='    <input type="checkbox" name="checkbox_api" id=""><label for="">'+api.openapiName+'</label> <a href="'+api.openapiUseUrl+'">'+api.openapiUseUrl.split('?')[0]+'</a>';
