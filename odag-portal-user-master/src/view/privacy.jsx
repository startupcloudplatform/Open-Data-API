      ...
      <div class="layout_inner">
        ...
        <div className="layout_inner">
          <section className="cont_guide">
            ...
            <div> 
             &lt;이노그리드&gt;(‘www.opendatamarket.com’이하 ‘Open Data Market’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다. <br/>
            ...
            <div> 
            ① &lt;이노그리드&gt;(‘www.opendatamarket.com’이하 ‘Open Data Market’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.<br/>
            ...
            <div> 
            ① &lt;이노그리드&gt;('www.opendatamarket.com'이하 'Open Data Market')은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br/>
            ② &lt;이노그리드&gt;('www.opendatamarket.com')은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.<br/>
            <br/>
            1. &lt;&gt;<br/>
            - 개인정보를 제공받는 자 : <br/>
            ...
            <div> 
            ① &lt;이노그리드&gt;('Open Data Market')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.<br/>
            <br/>
            1. &lt;&gt;<br/>
            - 위탁받는 자 (수탁자) : <br/>
            - 위탁하는 업무의 내용 : <br/>
            ...
            ② &lt;이노그리드&gt;('www.opendatamarket.com'이하 'Open Data Market')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.<br/>

            ③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.<br/>
            <br/>

            <h3 style={{ color: 'black' }}>5. 정보주체와 법정대리인의 권리·의무 및 그 행사방법 이용자는 개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다.</h3>
            <div> 
            ① 정보주체는 이노그리드(‘www.opendatamarket.com’이하 ‘Open Data Market) 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.<br/>
            1. 개인정보 열람요구<br/>
            ...
            <div>             
            ① &lt;이노그리드&gt;('www.opendatamarket.com'이하 'Open Data Market')은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br/>
            1&lt;이메일, 휴대전화번호&gt;<br/>
            - 필수항목 : 이메일, 휴대전화번호<br/>
            - 선택항목 :<br/>
            </div><br/>
            ...
            <h3 style={{ color: 'black' }}>7. 개인정보의 파기&lt;이노그리드&gt;('Open Data Market')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.</h3>
            <div> 
            -파기절차<br/>
            ...
            <div> 
            ① 이노그리드(‘www.opendatamarket.com’이하 ‘Open Data Market) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br/>
            <br/>
            ▶ 개인정보 보호책임자 <br/>
            성명 :김철수<br/>
            직책 :책임연구원<br/>
            직급 :팀장<br/>
            연락처 :010-1234-5678, naver@naver.com, 02-123-5678<br/>
            ...
            연락처 :, , <br/>
            <br/>
            ② 정보주체께서는 이노그리드(‘www.opendatamarket.com’이하 ‘Open Data Market) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 이노그리드(‘www.opendatamarket.com’이하 ‘Open Data Market) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br/>
            </div>
            <br/>
            ...
            <h3 style={{ color: 'black' }}>11. 개인정보의 안전성 확보 조치 &lt;이노그리드&gt;('Open Data Market')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.</h3>
            <div> 
            ...
            &lt;이노그리드&gt;('Open Data Market')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.<br/>
            <br/>
            4. 개인정보의 암호화<br/>
