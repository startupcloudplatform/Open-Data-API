...
class sub_request extends React.Component {
    constructor(...props) {
        ...
        this.state.notice_contents = this.props.notice_contents;
    ...
    _getData = async () => {
        ...
        await axios.get(urlstring)
            .then(response => 
            {
                ...
                console.log('information title = ' + this.state.rows.notice_title)
    ...
    rewriteButton = () => {
        var url = config.serverpoint + '/notice/notice_no/' + this.props.notice_no  + '/comment';
        ...
        if(!document.getElementById("title_text").value){
          ...
          axios.put(url,{
            notice_no : this.props.notice_no,
            notice_title: document.getElementById("title_text").value,
            notice_contents : document.getElementById("contents_text").value,
    ...
    render() {
        ...
        if(!!document.getElementById("title_text")){
            document.getElementById("title_text").value = this.state.rows.notice_title;            
        }
        if(!!document.getElementById("contents_text")){
            document.getElementById("contents_text").value = this.state.rows.notice_contents;            
