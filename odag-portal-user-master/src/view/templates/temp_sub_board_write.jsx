...
class sub_board extends React.Component {
  ...
  handlePopupCancle()
  {
    ...
    handleDeletePopup(community_no)
  {
    
    this.deleteboard();
    this.state.community_no = community_no;

    console.log('보낼 삭제 = ' +  community_no);
  }
  ...
  handleUp = async () =>{
    ...
    var urlstring = config.serverpoint + '/boards/targetup/' + this.props.community_no;
...
handleDown = async () =>{
    ...
    var urlstring = config.serverpoint + '/boards/targetdown/' + this.props.community_no;
