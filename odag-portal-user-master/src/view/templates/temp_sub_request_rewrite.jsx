...
class sub_request extends React.Component {
    constructor(...props) {
        ...
        this.state.request_contents = this.props.request_contents;
    ...
    _getData = async () => {
        ...
        await axios.get(urlstring)
            .then(response => 
            {
                ...
                console.log('information title = ' + this.state.rows.request_title)
    ...
    rewriteButton = () => {
        ...
        if(!document.getElementById("title_text").value){
          ...
          axios.put(url,{
            ...
            request_title: document.getElementById("title_text").value,
            request_contents : document.getElementById("contents_text").value,
    ...
    render() {
        ...
        if(!!document.getElementById("title_text")){
            document.getElementById("title_text").value = this.state.rows.request_title;            
        }
        if(!!document.getElementById("contents_text")){
            document.getElementById("contents_text").value = this.state.rows.request_contents;            
