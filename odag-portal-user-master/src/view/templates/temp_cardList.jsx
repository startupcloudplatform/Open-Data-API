...
class sub_cardList extends React.Component 
{
  ...
  _getData = async () => {
    ...
    if(this.state.word !== null && this.state.dataType == "data" && this.state.category == null) {
      requesturl += "search/data?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data" && this.state.category == "undefined") {
      requesturl += "search/data?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data" && this.state.category == this.state.category) {
      requesturl += "search/data?name=" + this.state.word + "&category=" + this.state.category;
    }    
    else if(this.state.word !== null && this.state.dataType == "data_oda" && this.state.category == null) {
      requesturl += "search/apilist?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data_oda" && this.state.category == "undefined") {
      requesturl += "search/apilist?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data_oda" && this.state.category == this.state.category) {
      requesturl += "search/apilist?name=" + this.state.word + "&category=" + this.state.category;
    }
    else if(this.state.word !== null && this.state.dataType == "data_file" && this.state.category == null) {
      requesturl += "search/filedata?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data_file" && this.state.category == "undefined") {
      requesturl += "search/filedata?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data_file" && this.state.category == this.state.category) {
      requesturl += "search/filedata?name=" + this.state.word + "&category=" + this.state.category;
    }
    else if(this.state.word !== null && this.state.dataType == "data_recommend" && this.state.category == null) {
      requesturl += "search/recommend?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data_recommend" && this.state.category == "undefined") {
      requesturl += "search/recommend?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data_recommend" && this.state.category == this.state.category) {
      requesturl += "search/recommend?name=" + this.state.word + "&category=" + this.state.category;
    }
    else if(this.state.word !== null && this.state.dataType == "data_recommend_history" && this.state.category == null) {
      requesturl += "recommandation/similar/"+sessionStorage.getItem("user") + "?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data_recommend_history" && this.state.category == "undefined") {
      requesturl += "recommandation/similar/"+sessionStorage.getItem("user") + "?name=" + this.state.word;
    }
    else if(this.state.word !== null && this.state.dataType == "data_recommend_history" && this.state.category == this.state.category) {
      requesturl += "recommandation/similar/"+sessionStorage.getItem("user") + "?name=" + this.state.word + "&category=" + this.state.category;
    }
    else if(this.state.word == null && this.state.dataType == "data_recommend_history" && this.state.category !== null) {
      requesturl += "recommandation/similar/"+sessionStorage.getItem("user") + "?category=" + this.state.category;
    }
    else if (this.state.category !== null){
      requesturl += "category/" + this.state.category;
    }
    else {
      if(this.state.dataType == "data_oda")
      {
        requesturl += "apilist";
      }
      else if(this.state.dataType == "data_file")
      {
        requesturl += "filedata";
      }
      else if(this.state.dataType == "data")
      {
        requesturl += "datalist";
      }
      else if(this.state.dataType == "data_recommend")
      {
        requesturl += "datalist/recommend";
      }
      else if(this.state.dataType == "data_recommend_history")
      {
        requesturl += "recommandation/similar/"+sessionStorage.getItem("user");
      }
    }   
    ...
    .then( response => 
    {
        ...
        for(var i = 0 ; i < response.data.length ; i++)
        {
          if(response.data == "검색 결과가 없습니다."){
            ...
            tempdatapack.openapi_category_odag = response.data[i].category;   
              ...
              .map(row => 
              {
                return (
                    ...
                    <li>
                      ...
                      <div className="cont_data_tit layout_clearfix" onClick={(e) => this.handleCardClick(row.openapi_no , row.activity_type)}>
                        <div className="cont_data_tit_category">{row.openapi_category_odag}  </div>
