            ...
            <header>
              <div className="header_logo">
                <div className="contentInner">
                  <h1><a href="../"><img src="../lib/images/logo.png" alt="Open Data API Gateway" /></a></h1>                  
                    <button
                        className={'usermenu'}
              ...
              <div className="header_nav">
                <div className="contentInner">
                  <nav>
                    <a href="../src/api.html" className="current">오픈 데이터 API 소개</a>
              ...
              <div className="contentInner">
                <div className="tab_btns_wrap">
                  <div className="tab_btns">
                    <a href="api.html" className="current">표준산업분류</a>
                ...
                <ul className="api_detailIist">
                  <li>
                    <div className="detailIist_tit">
                      ...
                      <div className="btns"><span className>사용신청완료</span></div>
                    </div>
                  ...
                  <li>
                    <div className="detailIist_tit">
                      ...
                      <div className="btns"><button type="button" className="btn_detail_download">다운로드</button></div>
                    </div>
                    <div className="detailIist_cont">
                      우정사업본부에서는 도로명주소 체계로 변경되는 새우편번호 및 기존 우편번호 정보를 조회하는 기능의 오픈API입니다. 우정사업본부
                      에서는 도로명주소 체계로 변경되는 새우편번호 및 기존 우편번호 정보를 조회하는 기능의 오픈API입니다.
                  ...
                  <li>
                    <div className="detailIist_tit">
                      ...
                      <div className="btns"><button type="button" className="btn_detail_app">사용신청</button></div>
                    </div>
                    <div className="detailIist_cont">
                      우정사업본부에서는 도로명주소 체계로 변경되는 새우편번호 및 기존 우편번호 정보를 조회하는 기능의 오픈API입니다. 우정사업본부
                      에서는 도로명주소 체계로 변경되는 새우편번호 및 기존 우편번호 정보를 조회하는 기능의 오픈API입니다.
                ...
                <div className="btm_btn">
                  <button type="button" className="btn_confirm">즐겨찾기 추가</button>
                </div>
                <aside>
                  <section>
                    <h3>인기 검색어</h3>
            ...
            <div className="popup">
              ...
              <div className="pop_cont_wrap">
                ...
                <div className="pop_btns">
                  <button type="button" id className="btn_pop_cancel">취소</button>
                  <button type="submit" id className="btn_pop_submit">확인</button>
                </div>
              </div>
            </div>
          </div>          
