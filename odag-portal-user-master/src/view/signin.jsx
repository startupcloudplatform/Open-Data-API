    ...
    return (
      ...
      <div className="logo3"><img src={ require("../assets/images/logo3.png")} alt="과학기술정보통신부"></img></div>
        ...
        <Paper className="class_paper">
         ...
         <div className="signdiv"> 포털 회원가입 <span className="sign">Register for portal</span></div>
         
            <section>
            <div class="membership_txt">회원가입을 하시면 Open Data Market에서 제공하는 정보를 자유롭게 사용 가능합니다.<br/>
