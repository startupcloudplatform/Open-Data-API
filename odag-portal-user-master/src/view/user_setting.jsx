...
if(!document.getElementById("password").value){
    ...
    // }
      ...
      var hashPassword = crypto.createHash("sha256").update(document.getElementById("password").value).digest("hex");
    ...
    return (
      ...
      <div className="logo2"><img src={ require("../assets/images/footer_logo.png")} alt="nipa 정보통신산업진흥원"></img></div>
        ...
        <Paper className="class_paper">
          ...
          <div className="signdiv"> 개발자 회원 수정 <span className="sign">Open Data Market</span></div>
         <section></section>
            ...
            패스워드 확인<span className="h3">*</span></div>
              ...
              <Grid item xs={12} sm={4}></Grid>
                        <Grid item xs={12} sm={2}>
                            <div className="h2"> <br></br>
                            사용자 이름<span className="h3">*</span></div>
                        ...
                        <Grid item xs={12} sm={6}>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            사용자 직업<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            자기 소개<span className="h3">*</span></div>
                          </Grid>
                          <Grid item xs={12} sm={10}>
                            <TextField class="wrap_inputBtn"
                              id="introduce"
        ...
        {this.state.popupType == 2 && 
                ...
                <div class="pop_cont_wrap">
                    ...
                    <div class="pop_btns">
                    <button type="submit" class="pop_btn_submit" onClick={this.deleteuser}>확인</button>
