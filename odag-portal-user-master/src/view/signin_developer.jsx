    ...
    return (
      ...
      <div className="logo3"><img src={ require("../assets/images/logo3.png")} alt="과학기술정보통신부"></img></div>
        ...
        <Paper className="class_paper">
          ...
          <div className="signdiv"> 개발자 회원가입 <span className="sign">Open Data Market</span></div>
         <section></section>
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Grid item xs={12} sm={4}>
              <Button type="button" variant="contained" color="primary" class="password_btn" onClick={this.handleSame}>
                중복검사
              </Button>
              </Grid>
            ...
            패스워드 확인<span className="h3">*</span></div>
              ...
              <Grid item xs={12} sm={4}></Grid>
                        ...
                        <Grid item xs={12} sm={6}>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            연락처<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            메일주소<span className="h3">*</span></div>
                          </Grid>
                          ...
                          <div className="h2">
                            관심 카테고리<span className="h3">*</span></div>
