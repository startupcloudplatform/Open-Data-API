    ...
    return (
      ...
      <div class="layout_inner">
            ...
            <nav class="header_nav">
                <ul class="header_nav_menu">
                    <li class="on2"><a href="../src/guide.html">이용안내</a></li>
      ...
      <table class="tb_board_write">
                    ...
                    <tr>
                        <th>이메일</th>
                        <td>
                          <input type="text" id="" placeholder="답변받을 이메일을 입력해 주세요 ex) opendatamarket@gmail.com"
                            className={classes.textField}
                            value={this.state.name}
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <textarea type="text" id="" placeholder="문의 내용을 입력해 주세요"
                            className={classes.textField}
                            value={this.state.name}
        ...
        <div class="cont_data_btns">
                    <button type="submit" class="btn_btm_submit" onClick={this.writeButton}>문의하기</button>
