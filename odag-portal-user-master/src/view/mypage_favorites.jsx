        ...
        <div>
          <section className="sub_nav" style={{ marginTop: '80px', marginBottom: '0px' }}>
            ...
            <div className="sub_nav_menu">
              <a href="/src/mypage.html">
                나의 오픈 API
              </a>
              <a href="/src/mypage_history.html">나의 사용이력</a>
              <a href="/src/mypage_favorites.html" className="on2">즐겨찾기</a>
            </div>
        ...
        <div className="layout_inner layout_clearfix">
          ...
          <div className="layout_sub_side">
            ...
            <div class="sub_nav_favorites">
                    ...
                    <button type="button" class="sub_nav_favorites_add" onClick={this.handlePopupOpen}><span>Add</span></button>
                    ...
                    <ul class="sub_nav_favorites_menu">
                      ...
                      rows2
                          ...
                          .map(row => 
                          {
                              return (                         
                              <li
                                id={row.bookmark_no} onClick={() => this.handleCardClick(row.bookmark_no)}> {row.bookmark_name}
                                <button id = 'delete_button' value = {row.bookmark_no} type="button" class="sub_nav_favorites_delete" onClick={() => this.handleDeletePopup(row.bookmark_no)}><span>Delete</span></button>                                            
                              </li>                          
                              );                          
                          })                     
                      }
            ...
            <div className="cont_msg"> 
              {
                ...
                <>
              <div className="cont_msg_inner"><span class="ico_notice">좌측 + 버튼을 통해 분류함을 만들어주세요</span></div>
              </>
              }      
            </div>
            {}
                ...
                <div class="pop_cont_wrap">
                    <div class="pop_cont">
                        <div class="pop_cont_select">
                            ...
                            <textarea type="text" id="favorites_text" placeholder="분류함 이름을 작성해주세요"                            
                    ...
                    <div class="pop_btns">
                        <button type="submit" class="pop_btn_submit" onClick={this.handleAddButton}>확인</button>
...
{this.state.popupType == 2 &&
                ...
                <div class="pop_cont_wrap">
                    ...
                    <div class="pop_btns">
                    <button type="submit" class="pop_btn_submit" onClick={this.handleDeleteButton}>확인</button>
                        <button type="button" class="pop_btn_cancel" onClick={this.handlePopupCancle}>취소</button>
