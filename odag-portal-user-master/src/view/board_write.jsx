...
import $ from "jquery";
window.$ = $;
class board_write extends React.Component 
{
    ...
    return (
      ...
      <table class="tb_board_write">
        ...
        <div class="cont_data_btns">
                    ...
                    <button type="button" class="btn_btm_cancel" onClick={this.handleReturnCardList}>취소</button>
                </div>
      </div>
      </div>  
        </main>
...
export default withStyles(styles)(board_write);