...
class board_rewrite extends React.Component 
{
  ...
  writeButton = () => {
    var url = config.serverpoint + '/boards';

    console.log("보낼 url = " + url);
    console.log("보낼 제목 = " + this.state.community_title);
    console.log("보낼 내용 = " + this.state.community_contents);

    if(!this.state.community_title){
      alert("제목을 입력하세요")
      return;
    }

    else if(!this.state.community_contents){
      alert("내용을 입력하세요")
      return;
    }
    ...
    return (
          ...
          <ul className="header_nav_menu">
            ...
            <a href="/notice">정보공유</a>
              <div className="header_nav_menu_sub js_nav_menu">
                ...
                <a href="/request.html">API 요청 게시판</a>
              </div>
            </li>
            <li>
              ...
              <div className="header_nav_menu_sub js_nav_menu">
                ...
                <a href="#" onClick = {this.handleReady}>나의 사용이력</a>
                <a href="#" onClick = {this.handleReady}>즐겨찾기</a>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div>
          <section className="sub_nav" style={{ marginTop: '100px', marginBottom: '0px' }}>
            ...
            <div className="sub_nav_menu">
              ...
              <a href="/board" className="on">자유게시판</a>
      ...
      <table class="tb_board_write">
                    ...
                    <tr>
                        <th>제목</th>
                        <td>
                          <input type="text" id="" placeholder={this.state.community_no}
...
export default withStyles(styles)(board_rewrite);