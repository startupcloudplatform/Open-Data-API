...
class Signin_provider extends React.Component {
  ...
  _getData = async () => {
    ...
    await axios.get('http://192.168.100.53:9000/category')
      .then(response => {
  ...
  submmitButton2 = () => {
    ...
    else if(!pattern2.test(this.state.passwordsame) || !pattern3.test(this.state.passwordsame) || !pattern4.test(this.state.passwordsame) || this.state.passwordsame.length < 8 || this.state.passwordsame.length > 12){
    ...
    return (
      ...
      <div className="logo3"><img src={ require("../assets/images/logo3.png")} alt="과학기술정보통신부"></img></div>
        ...
        <Paper className="class_paper">
          ...
          <div className="signdiv"> 제공처 회원가입 <span className="sign">Open Data Market</span></div>
         <section></section>
            ...
            아이디<span className="h3">*</span></div>
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Grid item xs={12} sm={2}>
            <div className="h2"> <br></br>
            패스워드<span className="h3">*</span></div>
              ...
              <Grid item xs={12} sm={2}>
            <div className="h2"> <br></br>
            패스워드 확인<span className="h3">*</span></div>
            </Grid>
              ...
              <Grid item xs={12} sm={4}></Grid>
                        <Grid item xs={12} sm={2}>
                            <div className="h2"> <br></br>
                            관리자 이름<span className="h3">*</span></div>
                        ...
                        <Grid item xs={12} sm={6}>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            기관 이름<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            기관 종류<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2">
                            카테고리<span className="h3">*</span></div>                         
                          </Grid>
                          ...
                          <Grid item xs={12} sm={2}>
                            <div className="h2"> <br></br>
                            회사 소개<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                            <div className="h2"> <br></br>
                            관리자 연락처<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                            <div className="h2"> <br></br>
                            관리자 메일 주소<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            관리자 직급<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            관리자 부서<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            기관 주소<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            승인 기간<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            승인 종류<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            승인 상태<span className="h3">*</span></div>
                          ...
                          <Grid item xs={12} sm={2}>
                          <div className="h2"> <br></br>
                            트래픽 제한<span className="h3">*</span></div>
