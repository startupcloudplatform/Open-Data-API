          ...
          <div className="layout_inner">
            <div className="header_top layout_clearfix">
              <h1 className="header_top_logo">
                <a href="/">
                  <img src="/lib/images/header_logo.png" alt="Cloudit" />
                </a>
              </h1>
              {
                session_nav()
          ...
          <div className="footer_cont">
            <div className="layout_inner layout_clearfix">
              <div className="footer_cont_logo">
                <a href="#">
                  <img
                    src="/lib/images/footer_logo_nipa.png"
                    alt="\uC815\uBCF4\uD1B5\uC2E0\uC0B0\uC5C5\uC9C4\uD765\uC6D0"
                  />
                </a>
                <a href="#">
                  <img
                    src="/lib/images/footer_logo_molit.png"
                    alt="\uAD6D\uD1A0\uAD50\uD1B5\uBD80"
                  />
                </a>
                <a href="#">
                  <img
                    src="/lib/images/footer_logo_innogrid.png"
                    alt="\uC774\uB178\uADF8\uB9AC\uB4DC"
                  />
                </a>
              </div>
            ...
            <div className="layout_inner layout_clearfix">
              <div className="footer_address_company">
                <p className="footer_address_company_address">
                  서울시 서초구 강남대로 623 우일빌딩 10층 ( 서울시 서초구
                  잠원동 12-5,6 ) 이노그리드
                </p>
                <p>
