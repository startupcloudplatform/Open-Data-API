			...
			<div class="contentInner">
				<h1>
					<a href="<c:url value="/"/>"><img
						...
						alt="Open Data API Gateway"></a>
				</h1>
				<c:choose>
					<c:when
						test="${sessionScope.SESSION_USER.userId ne null && sessionScope.SESSION_USER.userId ne ''}">
						<div class="usermenu" style="width: 90px;">
							<button type="button">
								<span class="btn_user"><c:out
										value="${sessionScope.SESSION_USER.userName}" /></span>
							</button>
							<ul>
		...
		var printNoticeDetail = function() {
			...
			$.ajax({
				...
				success : function(serverData) {
					noticeInfo = serverData.noticeInfo;

					$("#noticeTitle").text(noticeInfo.noticeTitle);
					$("#noticeContents").text(noticeInfo.noticeContents);
					$("#createTime").text(noticeInfo.createTime);
