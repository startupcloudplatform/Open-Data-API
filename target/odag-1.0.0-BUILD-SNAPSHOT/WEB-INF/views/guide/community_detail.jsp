...
<body>
	...
	<div class="contentInner">
		...
		<!-- 카뮤니티 상세 출력 테이블 -->
		<h2 class="bookmark_title">커뮤니티</h2>
		<table width="100%" border="1">
			...
			<tbody>
				...
				<tr>
					<td colspan="4" height="500px" id="communityContents">본문 글</td>
				</tr>
		...
		<table width="100%" border="1">
			...
			<!-- 
				<tr>
					<td id="creteUserNo">작성자</td>
					<td id="communityTitle" colspan="2">댓글</td>
					<td id="createTime">등록일</td>
				</tr>
			-->
			</tbody>
		</table>
		...
		var printCommunityDetail = function() {
			...
			$.ajax({
				...
				success : function(serverData) {
					...
					$("#communityContents").text(communityInfo.communityContents);
			...
			$.ajax({
				...
				success : function(serverData) {
		            ...
		            $(communityReplyList).each(function(categoryReplyIdx) {
		            	...
		            	html += '  <td id="createTime">'+communityReplyList[categoryReplyIdx].createTime+'</td>';
		            	html += '</tr>';
