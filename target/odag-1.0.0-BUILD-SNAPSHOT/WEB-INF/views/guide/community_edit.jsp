          ...
          <form method="post" action="communityUpdate">
            <table width="100%" border="1">
              ...
              <tbody>
                <tr>
                  <th scope="row">제목</th>
                  <td><input name="communityTitle" type="text" id="communityTitle"></td>
                  <th scope="row">공개 기간</th>
                  <td><div class="notice_period"><input type="text"/>일</div></td>
                </tr>
                <tr>
                  <td colspan="4" height="500px"><textarea name="communityContents" id="communityContents"></textarea></td>
                </tr>
              </tbody>
            </table>
    ...
    var printCommunityDetail = function() {
      $.ajax({
        ...
        success : function(serverData) {
          ...
          $("#communityTitle").attr("value", communityInfo.communityTitle);
